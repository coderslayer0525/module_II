...
import ss8_cleanCode_mvc.service.SedansService;
import ss8_cleanCode_mvc.service.ISedansService;
import ss8_cleanCode_mvc.view.CarsView;

import java.util.ArrayList;
import java.util.Scanner;

public class SedansController {
    private ISedansService sedansService = new SedansService();
        ...
        while (flag){
            ...
            switch (choice){
                case 1:
                    ...
                    ArrayList<Sedans> SedansList = this.sedansService.findAll();
                    CarsView.display(SedansList);
                    break;
                case 2:
